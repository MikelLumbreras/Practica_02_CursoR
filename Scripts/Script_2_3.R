...
#### AHORA USANDO LAS FUNCIONES QUE HEMOS CREADO VAMOS A IR EJECUTANDO
### DIVIDIMOS TRAINING Y TESTING
TrainingFrame <- TrainingTesting(DatosEdificio)[[1]]
TestingFrame <- TrainingTesting(DatosEdificio)[[2]]
...
FrameMetricasError[1,] <- MetricasError(Regresion_UniqueVariable , TestingFrame)
FrameMetricasError[2,] <- MetricasError(Regresion_MultiVariable , TestingFrame)

### DIBUJAMOS Y LO GUARDAMOS AUTOMATICAMENTE
PloteandoRegresiones(Regresion_UniqueVariable , Regresion_MultiVariable , TestingFrame)
setwd("C:/Users/mlumbreras001/OneDrive/Tecnalia/ProyectosR/Practica_02_CursoR/Data")
